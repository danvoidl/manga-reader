<template>
  <nav class="relative w-full h-16 font-sans min-w-full mb-5 bg-main z-10 ">
      ...
      <div class="flex items-center h-16">
        <div >
          <ul class="flex text-gray-50 ">
            <li :key="option" v-for="option in navOptions" class="h-8 flex items-center cursor-pointer border-b border-transparent hover:border-b-2 hover:border-yellow-400 m-6" > {{option.name}} </li>            
          </ul>
        </div>
